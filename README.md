...
An advanced interactive particle physics sandbox built with HTML5 Canvas and JavaScript. Create, manipulate, and experiment with thousands of particles in real-time.
...
6. Try different presets for quick setups
7. Save your favorite configurations

## Controls

- Left Click: Spawn particles
- Drag: Create particle trails
